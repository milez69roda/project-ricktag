				...
				<div id = "wrapper-main-top-960">
						<div id = "top-wrap">
							...
							<div id = "h-login-area">
								...
								<p style = "width:285px; margin-top:7px">
									<!--<label>enter 8 digit number</label>
									<input type = "text" name = "card1" value = "<?php //echo @$_GET["c1"]; ?>" maxlength = "4" placeholder = "0000"/> -->
									<label style = "margin-left:49px;" class = "wht">what's this?</label>
									
									<input type = "text" name = "card2" value = "<?php echo @$_GET["c2"]; ?>" maxlength = "8" placeholder = "00000000" tabindex="1"/> 
									<label style = "margin-left:20px;"><a href = "<?php echo base_url().(@$this->distributor_url).'/forgotpassword'; ?>" class = "forgot_pass fancybox fancybox.ajax" title = "">forgot password?</a></label>
									<input type = "password" name = "pwd" value = "" placeholder = "password" style = "width:105px;" tabindex="2"/> 
								</p>
									...
									<div id = "top-3-right">
										<div class = "reg_card">
											...
											<form action = ""  method = "post" onsubmit="return Midas.register(this)">
												...
												<p><input type="checkbox" name="terms" id="terms" value="1" checked="checked"/>Yes, I agree to the <a href = "<?php echo base_url().'midas/howitworks'; ?>" title = "Terms and Conditions" style = "color:#000;">terms and conditions</a></p>
