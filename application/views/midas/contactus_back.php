	...
	<div id = "content_main">
		<div id = "side_left">
			<form id="contactus_form" name="contactus_form" action="" method="contactus_form" onsubmit="return Midas.contactus_action(this);">
				...
				<p class = "_sec">
					...
					<img src="<?php echo base_url().$this->distributor_url; ?>/captcha/?_t=<?php echo strtotime('now'); ?>" title="Captcha" alt="Catcha" style="vertical-align: middle;padding: 3px 1px;border: 1px solid #BCBCBC;border-radius: 4px 4px 4px 4px;box-shadow: 1px 1px 3px 0 rgba(0, 0, 0, 0.3);"/>
					 
				</p>
				<p style = "margin-left:207px">
					<input type="image" src="static/midas/images/send_btn.png" name="submit" onmouseout="this.src='static/midas/images/send_btn.png'" onmouseover="this.src='static/midas/images/send_btn_hover.png'">
				</p>
			</form>
		</div>
		...
		<div id = "side_right">
			<div id = "right_box" class = "rbox">
				...
				<p>Email Us:<br />
					<span><a href = "">customerservice@ricktag.ca</a></span>
				</p>
