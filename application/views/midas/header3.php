						...
						<div id = "top-wrap">
							...
							<div id = "h-login-area">
								...
								<p style = "width:285px; margin-top:7px">
									...
									<label style = "margin-left:20px;"><a href = "<?php echo base_url().(@$this->distributor_url).'/forgotpassword'; ?>" class = "forgot_pass" title = "Forgot Password">forgot password?</a></label>
