...
<div id="main">
	...
	<div id="tray" class="box">
		...
		<p class="f-left box">
			...
			User: <strong><a href="#">Administrator</a></strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong><a href="admin/logout" id="logout">Log out</a></strong> 
		</p>
			...
			<ul class="box">
				...
				<li id="submenu-active"><a href="javascript:void(0)">Manage</a> <!-- Active -->
					<ul>
						...
						<li><a href="admin/cardholders">Registered Card-Members</a></li>
						<li><a href="admin/operators">Operators Manager</a></li>  
						<li><a href="admin/messages">Operators Ticker<?php echo ($this->msg_unread > 0)?'<strong style="color:red">('.$this->msg_unread.')</strong>':''; ?></a></li>  
						<li><a href="admin/featured">Featured List</a></li>  
					</ul>
				</li>
				<li id="submenu-active"><a href="javascript:void(0)">Manage Card Activity</a> <!-- Active -->
					<ul>
						<li><a href="admin/carc">Reward Card</a></li>
						<li><a href="admin/cagc">Gift Card</a></li>
					</ul>
				</li>				
