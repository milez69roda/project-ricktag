	...
	$(document).ready(function() {
		...
		<div id="content" class="box">
			...
			<a href="admin/businessmanager_add">Create New Distributor</a>				 
			<div> 
				<br />
				<table id="example">
					<thead>
					...
					<tbody>
						...
						<tr id="busi_tr_<?php echo $row->dist_id; ?>">
							...
							<td style="font-size:10px"><a href="admin/businessmanager_update/<?php echo $row->dist_id; ?>">Edit</a> <br />
								<a href="admin/businessmanager_howitworks/<?php echo $row->dist_id; ?>">How it works</a> <br />
								<a href="admin/businessmanager_view/<?php echo $row->dist_id; ?>">View</a>
							</td>
						</tr>	
						<?php endforeach; ?>					
