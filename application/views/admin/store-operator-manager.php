	...
	$(document).ready(function() {
		...
		<div id="content" class="box">
			...
			?>
			<h2> Manage <a href="admin/operators" style="color:red" >Operators</a> / <a href="admin/operators_admin">Distributors - card activity login</a></h2>
				...
				<table id="example">
					...
					<tbody>	
						...
						<tr id="optr_in_tr_<?php echo $row->ID; ?>">
							...
							<td><a href="admin/operators_edit/store/<?php echo $row->ID; ?>">Edit</a></td>
						</tr>	
						<?php endforeach; ?>					
