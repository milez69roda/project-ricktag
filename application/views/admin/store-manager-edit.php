		...
		<div id="content" class="box">
			...
			<div id="tabs">
				<ul>
					...
					<li><a href="#tabs-2">Stores City Link</a></li>  
					<li><a href="#tabs-3">Stores Category Link</a></li>  
					<li><a href="#tabs-4">Stores Deals List</a></li>  
					<li><a href="#tabs-5">Carpal Option</a></li>  
				</ul>
							...
							<table class="nostyle">
								<tbody>
									...
									<tr>
										...
										<td>
											<input  name="featured_big_banner" type="checkbox" value="1" <?php echo ($store->featured_big_banner)?'checked="true"':'' ?>   /> 
										</td>
									</tr>
									<tr>
										<td class="va-top">Featured Short Description:</td>
										<td><textarea name="featured_short_desc" class="input-text" rows="7" cols="35"><?php echo $store->featured_short_desc; ?></textarea></td>
									</tr>	
				...
				<div id="tabs-5">
					<fieldset>
						<label><h2>Carpal Option</h2></label>
						<table class="nostyle">
							<thead>
								<tr>
									<th>Option</th>
							...
							<tbody>	
								<tr>
									<td>Gift Card</td>	
									<td><input type="checkbox" id="carpal_gc_<?php echo $store->id; ?>"  onclick="Admin.cardpaloption(<?php echo $store->id; ?>,'gc')" value="<?php echo  $store->cp_show_gc; ?>"   <?php echo ( $store->cp_show_gc == 1 )? "checked":""; ?> /></td>	
								</tr>
								<tr>
									<td>Reward Card</td>	
									<td><input type="checkbox"  id="carpal_rc_<?php echo $store->id; ?>" onclick="Admin.cardpaloption(<?php echo $store->id; ?>,'rc')" value="<?php echo  $store->cp_show_rc; ?>"  <?php echo ( $store->cp_show_rc == 1 )? "checked":""; ?> /></td>	
								</tr>
								<tr>
									<td>Register</td>	
									<td><input type="checkbox"  id="carpal_reg_<?php echo $store->id; ?>" onclick="Admin.cardpaloption(<?php echo $store->id; ?>,'reg')" value="<?php echo  $store->cp_show_reg; ?>"   <?php echo ( $store->cp_show_reg== 1 )? "checked":""; ?>/></td>	
								</tr>
							</tbody>						
						</table> 
					</fieldset>	
