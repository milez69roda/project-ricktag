	...
	<div id = "top_fixed">
		<div id = "top">
						...
						<div id = "top_right" style = " width: 310px;">
							...
							<ul>
								<li style = "padding-right:10px; padding-left:10px;"><p style = "color:#fff; font-size:14px;  margin-right: 10px;  margin-top: 8px;">My Points</p><p style = "color:#fff; font-size:20px;  margin-top: 8px;">168,000</p></li>
				...
				<div id = "header">
					...
					<div id = "details_section">
						...
						<div id = "details_section_right">
							...
							<ul>
								<li id = "list_deals" class = ""></li>
								<a href = "http://request.ricktag.ca/demo/new_members/map">
								<li id = "map_deals" class = ""></li></a>
								<li><img src = "<?php echo base_url(); ?>static/new_member/images/points_btn.png"></li>
							</ul>
						</div>
						<div class = "clear"></div>
					</div>
