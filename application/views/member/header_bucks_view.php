...
<head>
	...
	<?php if ($this->uri->segment(3) == "myspecialoffers") :?> <title>My Special Offers</title> <?php endif; ?>
	<?php if ($this->uri->segment(3) == "mycardhistory") :?> <title>My Card History</title> <?php endif; ?>	
	...
	<div id = "top_fixed">
		...
		<div id = "top">
						...
						<div id = "top_left">	
							...
							<p id="ccenter_name"><?php echo $info->city_name; //$this->session->userdata("CUR_CITY")->name; ?></p>
						...
						<div id = "top_right" style = " width: 310px;">
							...
							<ul>
								...
								<li style = "padding-right:10px; padding-left:10px; background:none;"><p style = "color:#fff; font-size:14px;  margin-right: 10px;  margin-top: 8px;" >My Reward Bucks</p><p style = "color:#fff; font-size:20px;  margin-top: 8px;"><?php echo $info->card_balance; ?></p></li>
			...
			<div id = "wrapper">
				<div id = "header">
					...
					<div id = "details_section">
						...
						<?php if ($this->uri->segment(3) == "myspecialoffers") :?> <h1>My Special Offers</h1> <?php endif; ?>
						<?php if ($this->uri->segment(3) == "mycardhistory") :?> <h1>My Card History</h1> <?php endif; ?>
						 
						</div>
						<div id="label-mem-since">Member Since: <?php  echo date('m/d/Y', strtotime($info->CREATE_DATE));   ?></div>
						<div class = "clear"></div>
					</div>
				</div><!--end of header -->
				<div id = "wrap-main">