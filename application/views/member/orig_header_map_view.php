...
<div id = "top_fixed">
		<div id = "top">
					...
					<div id = "top_right" style = " width: 310px;">
							...
							<ul>
								<li style = "padding-right:10px; padding-left:10px;"><p style = "color:#fff; font-size:14px;  margin-right: 10px;  margin-top: 8px;">My Points</p><p style = "color:#fff; font-size:20px;  margin-top: 8px;">0000000</p></li>
