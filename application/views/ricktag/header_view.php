	...
	<script type="text/javascript">	
		$(document).ready(function(){
			...
			$('.wht').mouseover(function(){
				...
				$('.this_ppop').fadeIn('slow');
				
			}).mouseout(function(){
				$('.this_ppop').fadeOut('slow');;
			}); 
		...
		<div id = "wrapper">
			<div id = "header">
				<div id = "header-log-area">
					<div id = "h-login-area">
						<p style = "margin-top:45px" class = "_member_txt">
						Have a Ricktag Card? Enter Your Number 
						</p>
						<form name="form1" action="" method="post">
						<div class = "this_ppop"><img src = "static/midas/images/what_this_img.png" alt = "" /></div>
						<p style = "margin-top:15px">
							<!-- <label>Enter 8 digit number</label>
							<input type = "text" name = "" value = "" />  -->
							<label style = "margin-left: 55px; font-size:10px;margin-top: 5px;" class = "wht">what's this?</label>
							
							<input type = "text" name = "card1" value = "enter number" onfocus="if (this.value == 'enter number') {this.value = '';}" onblur="if (this.value == '') {this.value = 'enter number';}"/> 
