<script>
	...
	function contactus_action(form){
		data = $(form).serialize();
		var baseurl = "<?php echo base_url(); ?>";
		$.ajax({
			type:"post",
			url:baseurl+"welcome/contactus_action",
			data:data,
			dataType:"json",
			success: function(xhr){
			
				
				var modal = $('<div title="Contact Us"><br/>'+xhr.txt+'</div>');					
...
<div id = "main_content">
	...
	<div id = "content_main">
		<div id = "side_left">
			<form id="contactus_form" name="contactus_form" action="" method="contactus_form" onsubmit="return contactus_action(this);">
				<p>
