		...
		<div id = "side_left">
			<form id="contactus_form" name="contactus_form" action="" method="contactus_form" onsubmit="return Midas.contactus_action(this);">
				...
				<p>
					...
					<select name = "help">
						<option> I am having trouble registering my card.</option>
						<option>I would like to suggest a business.</option>
						<option> My card was lost or stolen, how do I get a replacement?</option>
						<option> I would like to get a Ricktag Rewards card.</option>
						<option> I would like to get my business featured on Ricktag.</option>
