...
class Admin extends CI_Controller {
	...
	public function cardholders(){
		...
		$data = "";
		$this->db->select(" card_holders.ID,CARD_ID,CARD_TYPE, FIRSTNAME, LASTNAME, card_holders.EMAIL, card_holders.PHONE, GENDER, CONFIRMED, ACTIVE, cities.name as city_name, company_name, distributor_info.first_name, distributor_info.last_name, CREATE_DATE");
